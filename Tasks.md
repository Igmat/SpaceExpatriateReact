...
- [ ] - доделать tryBuildColony ** (Anastasia) **
    - [ ] - сбрасывать карты если условия соблюдены -> берется колония -> tryNext || tryBuildColony
    - [ ] - связать метод takeOpenedCard с методом постройки колонии (перемещении карты колонии на стол к игроку) 
- [X] Создать новый менеджер для колоний (Maria)
- [ ] Добавить метод проверки карт колоний на столе при новом раунде: 
