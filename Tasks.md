...
- [ ] Создать функцию createCards (создается колода) (Anastasia)
- [ ] Создать DeckModel -> ColonyModel (Maria)
    - mixCard + openCard(3 штуки) + takeCard
- [ ] - сделать место для колоний на столе (Kira)
- [ ] - доделать tryBuildColony
